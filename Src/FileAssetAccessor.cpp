...
uint16_t FileResponse::statusCode() const { return 200; }

std::string FileResponse::contentType() const { return ""; }
...
FileRequest::FileRequest(
    ...
    : _url(url), _method("GET"), _headers(), _pResponse(std::move(pResponse)) {}

const std::string& FileRequest::method() const { return this->_method; }

const std::string& FileRequest::url() const { return this->_url; }
