...
void RayTracingPipelineBuilder::setIntersectionShader(const std::string& path) {
  // this->_intersectionShaderBuilder = ShaderBuilder(path, shaderc_intersection_shader);
}

void RayTracingPipelineBuilder::setClosestHitShader(const std::string& path) {
  this->_closestHitShaderBuilder = ShaderBuilder(path, shaderc_closesthit_shader);
}
